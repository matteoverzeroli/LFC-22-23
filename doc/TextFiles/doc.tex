...
\begin{itemize}
	...
	\item \texttt{DESCRIPTION\_POLARIZED\_ERROR}: è un caso particolare dell'errore precedente. Nel caso in cui il simbolo è \texttt{cap}, se la descrizione è presente deve essere uguale a \texttt{Polarized Capacitor};
	\item \texttt{DESCRIPTION\_POLARIZED\_NOCAPACITOR\_ERROR}: indica il caso in cui il simbolo è \texttt{cap} e ci sia solo la parola \texttt{Polarized} come \texttt{Description}, mentre l'applicazione si aspetta \texttt{Polarized Capacitor};
